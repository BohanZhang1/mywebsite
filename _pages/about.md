...
<div style="display:flex; gap:0.6em; flex-wrap:wrap; margin:1.2em 0 1.8em;">
  <span style="background:#1a5fa8; color:#fff; padding:4px 13px; border-radius:12px; font-size:0.82em; font-weight:500;">NASA ULI Sponsored</span>
  <span style="background:#1a5fa8; color:#fff; padding:4px 13px; border-radius:12px; font-size:0.82em; font-weight:500;">8 Publications</span>
  <span style="background:#1a5fa8; color:#fff; padding:4px 13px; border-radius:12px; font-size:0.82em; font-weight:500;">PhD Candidate · SLU 2027</span>
  <span style="background:#1a5fa8; color:#fff; padding:4px 13px; border-radius:12px; font-size:0.82em; font-weight:500;">IEEE RE · ASE · ICSE · PLANS</span>
</div>
...
<div style="background:#f4f7fb; padding:12px 16px; margin:5px 0; border-left:3px solid #1a5fa8; border-radius:0 6px 6px 0;">
...
<div style="padding:12px 16px; margin:5px 0; border-left:3px solid #aaa; border-radius:0 6px 6px 0;">
...
<div style="background:#f4f7fb; padding:7px 14px; margin:3px 0; border-radius:4px; font-size:0.93em;">
...
<div style="padding:7px 14px; margin:3px 0; border-radius:4px; font-size:0.93em;">
