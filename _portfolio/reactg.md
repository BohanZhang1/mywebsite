...
![React-G ray casting visualization in an urban environment](/mywebsite/images/reactg/react-g-overview.png)
...
![React-G system architecture diagram](/mywebsite/images/reactg/react-g-architecture.png)

*React-G's three-phase architecture: (1) **Configuration** — environment settings, satellite list, fidelity parameters; (2) **GNSS Simulation** — environment initialization via Cesium + Google Maps, LOS calculation, ray-traced NLOS multipath computation; (3) **Processing & Analysis** — material reflectivity filtering, output of LOS/NLOS path data.*

---

### Signal Path Visualization

![React-G merged visualization of LOS and NLOS signal paths across urban environment](/mywebsite/images/reactg/react-g-merged.png)
...
|:---:|:---:|
| ![Brick building photo](/mywebsite/images/reactg/react-g-brick.png) | ![React-G simulation of brick building](/mywebsite/images/reactg/react-g-brick-sim.png) |
...
| Real Environment | React-G Simulation |
|:---:|:---:|
| ![Modern glass building photo](/mywebsite/images/reactg/react-g-spring.png) | ![React-G simulation of glass building with dense NLOS reflections](/mywebsite/images/reactg/react-g-spring-sim.png) |
...
![NASA NavQ GNSS receiver testbed — SparkFun u-blox board with GNSS antenna on leveled platform](/mywebsite/images/reactg/navq-hardware.jpg)
